...
3. Calculated average profit margins for each level 
4. Aggregated metrics by discount level:
   - Total sales  
   - Total profit  
   - Average profit margin  
   - Number of customer orders  
5. Exported cleaned and aggregated data to a Excel file  

---

## Key Findings
- High discounts resulted in **lower profits and reduced profit margins**  
- High discount levels also attracted **fewer customers and fewer orders**  
- Low and Low-Medium discounts generated **significantly higher profits**  
- Lower discount levels had **more customers and higher order volumes**  
...
## Tools Used
- **Python (pandas, numpy, xlsxwriter)** for data cleaning, analysis, and Excel export  
- **MS Excel** for reviewing and analyzing output data  
